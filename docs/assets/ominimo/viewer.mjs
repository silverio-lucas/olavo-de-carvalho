...
const defaultOptions = {
  ...
  workerSrc: {
    value: "/assets/build/pdf.worker.mjs",
    kind: OptionKind.WORKER
  }
};
{
  defaultOptions.defaultUrl = {
    value: "o_minimo_que_voce_precisa_saber_para_nao_ser_um_idiota.pdf",
    kind: OptionKind.VIEWER
  };
  defaultOptions.sandboxBundleSrc = {
    value: "/assets/build/pdf.sandbox.mjs",
    kind: OptionKind.VIEWER
  };
...
class PDFPageView {
  ...
  constructor(options) {
    ...
    this.maxCanvasPixels = options.maxCanvasPixels ?? (_app_options_js__WEBPACK_IMPORTED_MODULE_4__.AppOptions.getCompat("maxCanvasPixels") || 16777216);
